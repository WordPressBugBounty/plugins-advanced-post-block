...
class HelpPage{
	...
	function adminEnqueueScripts( $hook ) {
		if( strpos( $hook, 'apb-help' ) ){
			wp_enqueue_style( 'apb-admin-help', APB_DIR_URL . 'build/admin-help.css', [], APB_VERSION );
			wp_enqueue_script( 'apb-admin-help', APB_DIR_URL . 'build/admin-help.js', [ 'react', 'react-dom' ], APB_VERSION, true );
